...
class AdversarySuite(ExperimentSuite):
    ...
    def _poses_town02_nemesis(self):
        """
        Each matrix is a new task. We have all the four tasks
    ...
    def build_experiments(self):
        ...
        if self._city_name == 'Town01':
            ...
            poses_tasks = [[self._poses_town01_nemesis()[task_select][self._scene-1]]]
            ...
            poses_tasks = [[self._poses_town02_nemesis()[task_select][self._scene-1]]]
            vehicles_tasks = [0, 0, 0, 0, 0, 0]
            pedestrians_tasks = [0, 0, 0, 0, 0, 0]
